...
namespace MartainsOrder.Items.Hooks
{
    internal class CowboyLasso : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Cowboy Lasso");
            Tooltip.SetDefault("Cannot leave the Player attached to tiles");
        }
        ...
        public override void SetDefaults()
        {
			...
			*/
            ...
            item.shoot = mod.ProjectileType("CowboyLassoProjectile");
        }
    ...
    internal class CowboyLassoProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Cowboy Lasso");
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            while (distance > 30f && !float.IsNaN(distance))
            {
                ...
                //Draw chain
                spriteBatch.Draw(mod.GetTexture("Items/Hooks/CowboyLassoChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
